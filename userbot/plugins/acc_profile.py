...
async def _(event):
    ...
    try:
        ...
        await event.edit("Succesfully changed my profile bio by @MAFIA_USERBOT")
...
async def _(event):
    ...
    try:
        ...
        await event.edit("My name was changed successfully by @MAFIA_USERBOT")
    except Exception as e:  # pylint:disable=C0103,W0703
        await event.edit(str(e))
...
async def _(event):
    ...
    await event.edit("🗨️Downloading Profile Picture to my local👀...")
    ...
    try:
        ...
        if photo:
            await event.edit("Now, Uploading to Cloud ☁️...")
